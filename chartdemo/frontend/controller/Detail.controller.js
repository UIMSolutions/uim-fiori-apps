sap.ui.define([
...
], function(Controller, Log, MessageToast, Popover, FeedItem, FlattenedDataset, DefaultPropertiesHelper) {
	"use strict";
	return Controller.extend("sap.ui.demo.chartdemo.controller.Detail", {
		...
		attachContentChange: function(evt) {
			...
			MessageToast.show("ContentChange event was fired. Selected Item was changed to:" + itemId);
		}
	});
});
