module uim.fiori.materials.adapters.outbound.repositories.memory;
import std.uuid : randomUUID;
import uim.fiori.materials;

@safe:
class InMemoryRepository : MaterialPort, PlanningPort, WarehousePort, StockPort, SupplierPort {
private:
    Material[] _materials;
    MaterialPlan[] _plans;
...
public:
    ...
    override Supplier[] listSuppliers() {
        return _suppliers.dup;
    }
private:
    void seed() {
        ...
        _suppliers = [
            Supplier(randomUUID().toString(), "Supplier A", "supplierA@example.com"),
            Supplier(randomUUID().toString(), "Supplier B", "supplierB@example.com")
        ];
    }
}
