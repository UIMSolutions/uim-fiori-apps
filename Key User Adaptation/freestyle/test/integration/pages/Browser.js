				...
				iShouldSeeTheHashForObjectN: function(iObjIndex) {
					return this.waitFor(this.createAWaitForAnEntitySet({
						...
						success: function(aEntitySet) {
							...
							QUnit.assert.strictEqual(sHash, "SEPMRA_C_PD_Product/" + aEntitySet[iObjIndex].ActiveProduct, "The Hash is not correct");
						}
					}));
				},
					...
					return this.waitFor({
						success: function() {
							var sObjectId = this.getContext().currentListItem.getBindingContext().getProperty("ActiveProduct"),
								...
								sHash = oHashChanger.getHash();
							QUnit.assert.strictEqual(sHash, "SEPMRA_C_PD_Product/" + sObjectId, "The Hash is not correct");
						}
					});
				},
				iShouldSeeAnEmptyHash: function() {
					return this.waitFor({
						success: function() {
							var oHashChanger = Opa5.getHashChanger(),
								sHash = oHashChanger.getHash();
							QUnit.assert.strictEqual(sHash, "", "The Hash should be empty");
						},
