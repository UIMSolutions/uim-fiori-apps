			...
			assertions: {
				iShouldSeeTheNotFoundGeneralPage: function(sPageId, sPageViewName) {
					return this.waitFor({
						...
						success: function() {
							QUnit.assert.ok(true, "Shows the message page");
						},
				...
				theNotFoundPageShouldSayResourceNotFound: function() {
					return this.waitFor({
						...
						success: function(oPage) {
							QUnit.assert.strictEqual(oPage.getTitle(), oPage.getModel("i18n").getProperty("notFoundTitle"),
								"The not found text is shown as title");
							QUnit.assert.strictEqual(oPage.getText(), oPage.getModel("i18n").getProperty("notFoundText"),
				...
				theNotFoundPageShouldSayObjectNotFound: function() {
					return this.waitFor({
						...
						success: function(oPage) {
							QUnit.assert.strictEqual(oPage.getTitle(), oPage.getModel("i18n").getProperty("detailTitle"), "The object text is shown as title");
							QUnit.assert.strictEqual(oPage.getText(), oPage.getModel("i18n").getProperty("noObjectFoundText"),
