...
unittest {
    ...
    void main() {
        auto primitiveTypeRef = new EdmPrimitiveTypeRef(EdmPrimitiveType.String);
        assert(primitiveTypeRef.typeKind() == EdmTypeKind.Primitive);
        assert(primitiveTypeRef.name() == "String");
        assert(primitiveTypeRef.fullName() == "String");
        assert(primitiveTypeRef.primitiveType() == EdmPrimitiveType.String);
