...
//         static if (uim.core.uda.helpers.hasUDA!(T, ODataEntitySet)) {
...
//                     static if (uim.core.uda.helpers.hasUDA!(member, ODataKey)) {
...
//                     static if (uim.core.uda.helpers.hasUDA!(member, ODataForeignKey)) { // Check if it has the ODataForeignKey UDA
...
//                     alias member = __traits(getMember, T, memberName);
//                     alias MemberType = typeof(member);
//                     static if (uim.core.uda.helpers.hasUDA!(member, ODataNavigationProperty)) {
